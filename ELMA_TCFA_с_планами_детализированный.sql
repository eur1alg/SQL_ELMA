...
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
----------------- Теперь TCFA LIST с учетом запланированных визитов -------------------------
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
...
WHERE 
(
ELMA_DB..ELMA_TABLE_Activity_2.Activity_RecordType_name = 'Визит в аптеку' AND 
ELMA_DB..ELMA_TABLE_Activity_2.Activity_Status = 'Завершен' AND 
ELMA_DB..ELMA_TABLE_Activity_2.Activity_startAt between @start_cycle_date and @end_cycle_date AND
ELMA_DB..ELMA_TABLE_Activity_2.Activity_createdBy = [ELMA_VIEW_UsersStructDetails].Users_id AND [ELMA_VIEW_UsersStructDetails].UserDetails_UserDivision = 'General'
)
...
(
ELMA_DB..ELMA_TABLE_Activity_2.Activity_RecordType_name = 'Визит в аптеку' AND 
ELMA_DB..ELMA_TABLE_Activity_2.Activity_Status = 'Запланирован' AND 
...
WHERE 
(
ELMA_DB..ELMA_TABLE_Activity_2.Activity_RecordType_name = 'Визит к врачу' AND 
ELMA_DB..ELMA_TABLE_Activity_2.Activity_Status = 'Завершен' AND 
ELMA_DB..ELMA_TABLE_Activity_2.Activity_startAt between @start_cycle_date and @end_cycle_date AND
ELMA_DB..ELMA_TABLE_Activity_2.Activity_createdBy = [ELMA_VIEW_UsersStructDetails].Users_id AND [ELMA_VIEW_UsersStructDetails].UserDetails_UserDivision = 'General'
)
...
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
-------------------- Теперь TCFA SHORT для еженедельного отчета -----------------------------
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
